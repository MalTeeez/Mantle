...
public abstract class InventoryLogic extends TileEntity implements IInventory, IDebuggable {
    ...
    /*
     * public void superReadFromNBT (NBTTagCompound tags) { super.readFromNBT(tags); } public void superWriteToNBT
     * (NBTTagCompound tags) { super.writeToNBT(tags); }
     */
