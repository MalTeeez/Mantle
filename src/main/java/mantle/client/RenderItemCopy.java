...
public class RenderItemCopy extends Render {
    ...
    public void doRenderItem(EntityItem par1EntityItem, double par2, double par4, double par6, float par8, float par9) {
        ...
        if (itemstack.getItem() != null) {
            ...
            if (ForgeHooksClient.renderEntityItem(
                    ...
                    new RenderBlocks(),
                    000)) // TODO what goes here not 000
            {
                ;
    ...
    private void renderDroppedItem(EntityItem par1EntityItem, IIcon par2Icon, int par3, float par4, float par5,
        ...
        if (this.renderManager.options.fancyGraphics) {
            ...
            for (int l = 0; l < par3; ++l) {
                ...
                tessellator
                        .addVertexWithUV((double) (0.0F - f9), (double) (0.0F - f10), 0.0D, (double) f4, (double) f7);
                ...
                tessellator
                        .addVertexWithUV((double) (0.0F - f9), (double) (1.0F - f10), 0.0D, (double) f4, (double) f6);
                tessellator.draw();
                GL11.glPopMatrix();
            }
        }
     ...
     */
    public void renderItemIntoGUI(SmallFontRenderer par1FontRenderer, TextureManager par2TextureManager,
    ...
    public void renderItemIntoGUI(SmallFontRenderer par1FontRenderer, TextureManager par2TextureManager,
        ...
        // TODO renderItemIn3d
        if (block != null && par3ItemStack.getItemSpriteNumber() == 0
                && RenderBlocks.renderItemIn3d(block.getRenderType())) {
     ...
     */
    public void renderItemAndEffectIntoGUI(SmallFontRenderer par1FontRenderer, TextureManager par2TextureManager,
            ItemStack par3ItemStack, int par4, int par5) {
     ...
     * specified position.
     */
    public void renderItemOverlayIntoGUI(SmallFontRenderer par1FontRenderer, TextureManager par2TextureManager,
            ItemStack par3ItemStack, int par4, int par5) {
