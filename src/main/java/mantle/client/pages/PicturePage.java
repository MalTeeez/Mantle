...
public class PicturePage extends BookPage {
    ...
    public void readPageFromXML(Element element) {
        ...
        /*
         * nodes = element.getElementsByTagName("bookImage"); if (nodes != null) { //TODO 1.7 null check all of this
         * background = MantleClientRegistry.imageCache.get(nodes.item(0).getTextContent()).resource; if(background ==
         * null){ logger.warn(nodes.item(0).getTextContent() + " could not be found in the image cache(bookimage)!"); }
         * }
         */
