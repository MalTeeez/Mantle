 ...
 *
 * Note that all ILoadableModule's should have a static String field "modId" which contains the mod ID of the mod it
 * supports. This is accessed by reflection because Java is dumb and has no statics in interfaces.
 *
